...
duplicate API contracts or create competing anchors.
...
| `NegationPolicy`            | [`NegationPolicy`][fuzzyroutines.fuzzysets.NegationPolicy]                           |
| `Normalize`                 | [`Normalize`][fuzzyroutines.fuzzysets.Normalize]                                     |
| `SNormPolicy`               | [`SNormPolicy`][fuzzyroutines.fuzzysets.SNormPolicy]                                 |
